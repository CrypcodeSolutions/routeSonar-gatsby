      ...
      <Navbar collapseOnSelect expand="lg">
        ...
        <Navbar.Collapse id="responsive-navbar-nav" className='rs-navbar rs-navbar--res'>
          <Nav className="align-items-center fade-in">
            ...
            <Nav.Link href="#rsContact">Contact Us</Nav.Link>
            <Nav.Link onClick={() => viewPrivacy()}>Terms of Service</Nav.Link>
          </Nav>
          <a href="https://beta.routesonar.com" className='ms-auto rs-link rs-link--small rs-link--bg-variant rs-header__btn' target="_blank" rel="noreferrer">Get Started</a>
        </Navbar.Collapse>
        <Navbar.Offcanvas
